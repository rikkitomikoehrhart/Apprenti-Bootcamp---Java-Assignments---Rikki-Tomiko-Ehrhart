...
public class VisitFilterServiceTest {
    ...
    void getVisitsByProviderId() {
        int expectedSize = 2;
        assertEquals(expectedSize, visitFilterService.getVisitsByProviderId("ZXY21",
                TestData.getPatientVisits()).length);
    }
    @Test
    void getVisitsByPatientId() {
        int expectedSize = 2;
        assertEquals(expectedSize, visitFilterService.getVisitsByPatientId("ABC123",
                TestData.getPatientVisits()).length);
    }
}
